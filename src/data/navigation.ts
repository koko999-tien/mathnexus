import { LayoutDashboard, BookOpen, Library, Brain, PenTool, ChartSpline, Calculator, Sigma, Sparkles, NotebookPen, ChartNoAxesCombined, Activity, Network } from 'lucide-react';
