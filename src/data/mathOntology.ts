...
export const MATH_ATOMS: MathAtom[] = [
  ...
  { id:'mechanics-state', conceptId:'classical-mechanics', kind:'definition', title:'Trạng thái cơ học', summary:'Trạng thái của một hạt được mô tả bằng vị trí và vận tốc tại một thời điểm.', formula:'$(\\mathbf r,\\mathbf v): Record<string, string> = {
...
, tags:['state','position','velocity'] },
  { id:'newton-second-law', conceptId:'classical-mechanics', kind:'theorem', title:'Định luật II Newton', summary:'Gia tốc được xác định bởi tổng lực tác dụng chia cho khối lượng.', formula:'$m\\ddot{\\mathbf r}=\\sum \\mathbf F: Record<string, string> = {
  'alg-discriminant': 'quadratics',
  'geom-pythagoras-6-8': 'pythagoras',
  'calc-power-derivative': 'derivative-rules',
  'calc-antiderivative-2x': 'antiderivatives',
...
export const ATOM_BY_ID = new Map(MATH_ATOMS.map(atom => [atom.id, atom]));
, dependsOn:['mechanics-state'] },
  { id:'mechanics-momentum', conceptId:'classical-mechanics', kind:'definition', title:'Động lượng', summary:'Động lượng tuyến tính là tích giữa khối lượng và vận tốc.', formula:'$\\mathbf p=m\\mathbf v: Record<string, string> = {
  'alg-discriminant': 'quadratics',
  'geom-pythagoras-6-8': 'pythagoras',
  'calc-power-derivative': 'derivative-rules',
  'calc-antiderivative-2x': 'antiderivatives',
...
export const ATOM_BY_ID = new Map(MATH_ATOMS.map(atom => [atom.id, atom]));
, dependsOn:['mechanics-state'] },
  { id:'momentum-conservation', conceptId:'classical-mechanics', kind:'theorem', title:'Bảo toàn động lượng của hệ cô lập', summary:'Nếu tổng ngoại lực bằng 0 thì tổng động lượng của hệ không đổi theo thời gian.', formula:'$\\frac{d}{dt}\\sum_i \\mathbf p_i=0: Record<string, string> = {
  'alg-discriminant': 'quadratics',
  'geom-pythagoras-6-8': 'pythagoras',
  'calc-power-derivative': 'derivative-rules',
  'calc-antiderivative-2x': 'antiderivatives',
...
export const ATOM_BY_ID = new Map(MATH_ATOMS.map(atom => [atom.id, atom]));
, dependsOn:['mechanics-momentum','newton-second-law'] },
  ...
  { id:'gravity-force-law', conceptId:'newtonian-gravity', kind:'definition', title:'Định luật hấp dẫn nghịch đảo bình phương', summary:'Hai khối lượng hút nhau theo phương nối tâm với độ lớn giảm theo bình phương khoảng cách.', formula:'$F=G\\frac{m_1m_2}{r^2}: Record<string, string> = {
  'alg-discriminant': 'quadratics',
  'geom-pythagoras-6-8': 'pythagoras',
  'calc-power-derivative': 'derivative-rules',
  'calc-antiderivative-2x': 'antiderivatives',
...
export const ATOM_BY_ID = new Map(MATH_ATOMS.map(atom => [atom.id, atom]));
, dependsOn:['gravity-force-law'] },
  { id:'gravity-potential-energy', conceptId:'newtonian-gravity', kind:'definition', title:'Thế năng hấp dẫn', summary:'Mỗi cặp khối lượng đóng góp một thế năng âm tỷ lệ nghịch với khoảng cách.', formula:'$U_{ij}=-G\\frac{m_im_j}{r_{ij}}: Record<string, string> = {
  'alg-discriminant': 'quadratics',
  'geom-pythagoras-6-8': 'pythagoras',
  'calc-power-derivative': 'derivative-rules',
  'calc-antiderivative-2x': 'antiderivatives',
...
export const ATOM_BY_ID = new Map(MATH_ATOMS.map(atom => [atom.id, atom]));
, dependsOn:['gravity-force-law'] },
  { id:'gravity-two-body-example', conceptId:'newtonian-gravity', kind:'example', title:'Quỹ đạo gần tròn quanh khối lượng lớn', summary:'Với khối lượng trung tâm lớn, tốc độ quỹ đạo tròn xấp xỉ căn của GM/r.', formula:'$v\\approx\\sqrt{GM/r}: Record<string, string> = {
  'alg-discriminant': 'quadratics',
  'geom-pythagoras-6-8': 'pythagoras',
  'calc-power-derivative': 'derivative-rules',
  'calc-antiderivative-2x': 'antiderivatives',
...
export const ATOM_BY_ID = new Map(MATH_ATOMS.map(atom => [atom.id, atom]));
, dependsOn:['gravity-vector-acceleration'] },
  ...
  { id:'nbody-energy-drift', conceptId:'nbody-problem', kind:'subskill', title:'Đọc energy drift', summary:'Theo dõi độ lệch năng lượng tương đối giúp đánh giá chất lượng tích phân số trong một hệ bảo toàn gần lý tưởng.', formula:'$\\delta_E=\\left|\\frac{E(t)-E(0)}{E(0)}\\right|: Record<string, string> = {
  'alg-discriminant': 'quadratics',
  'geom-pythagoras-6-8': 'pythagoras',
  'calc-power-derivative': 'derivative-rules',
  'calc-antiderivative-2x': 'antiderivatives',
...
export const ATOM_BY_ID = new Map(MATH_ATOMS.map(atom => [atom.id, atom]));
, dependsOn:['gravity-potential-energy','nbody-step-size'] },
  ...
  { id:'hamiltonian-phase-space', conceptId:'hamiltonian-mechanics', kind:'definition', title:'Không gian pha', summary:'Một trạng thái được biểu diễn bằng tọa độ q và động lượng p thay vì chỉ vị trí.', formula:'$(\\mathbf q,\\mathbf p): Record<string, string> = {
  'alg-discriminant': 'quadratics',
  'geom-pythagoras-6-8': 'pythagoras',
  'calc-power-derivative': 'derivative-rules',
  'calc-antiderivative-2x': 'antiderivatives',
...
export const ATOM_BY_ID = new Map(MATH_ATOMS.map(atom => [atom.id, atom]));
  ...
  { id:'hamiltonian-definition', conceptId:'hamiltonian-mechanics', kind:'definition', title:'Hamiltonian', summary:'Trong nhiều hệ cơ học, Hamiltonian biểu diễn tổng động năng và thế năng.', formula:'$H(\\mathbf q,\\mathbf p)=T+V: Record<string, string> = {
  'alg-discriminant': 'quadratics',
  'geom-pythagoras-6-8': 'pythagoras',
  'calc-power-derivative': 'derivative-rules',
  'calc-antiderivative-2x': 'antiderivatives',
...
export const ATOM_BY_ID = new Map(MATH_ATOMS.map(atom => [atom.id, atom]));
, dependsOn:['hamiltonian-phase-space'] },
  { id:'hamilton-equations', conceptId:'hamiltonian-mechanics', kind:'theorem', title:'Phương trình Hamilton', summary:'Động lực học được viết thành hai hệ phương trình bậc nhất đối xứng theo q và p.', formula:'$\\dot q_i=\\frac{\\partial H}{\\partial p_i},\\quad \\dot p_i=-\\frac{\\partial H}{\\partial q_i}: Record<string, string> = {
  'alg-discriminant': 'quadratics',
  'geom-pythagoras-6-8': 'pythagoras',
  'calc-power-derivative': 'derivative-rules',
  'calc-antiderivative-2x': 'antiderivatives',
...
export const ATOM_BY_ID = new Map(MATH_ATOMS.map(atom => [atom.id, atom]));
, dependsOn:['hamiltonian-definition'] },
